    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnEdit.setOnClickListener(v -> {
            ...
            if (updatedGroup.isEmpty() || updatedAmount.isEmpty() || updatedDate.isEmpty()) {
                Toast.makeText(DialogDetail.this, "Please fill in all the information", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            db.collection("users")
                    ...
                    .addOnSuccessListener(aVoid -> {
                        Toast.makeText(DialogDetail.this, "Update successful", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent();
                        setResult(RESULT_OK, intent);
                        finish();
                    })
                    .addOnFailureListener(e -> {
                        Toast.makeText(DialogDetail.this, "Update error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    });
        });
            ...
            new android.app.AlertDialog.Builder(DialogDetail.this)
                    ...
                    .setPositiveButton("Yes", (dialog, which) -> {
                        db.collection("users")
                                ...
                                .delete()
                                .addOnSuccessListener(aVoid -> {
                                    Toast.makeText(DialogDetail.this, "Deletion successful", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent();
                                    setResult(RESULT_OK, intent);
                                    finish();
                                })
                                .addOnFailureListener(e -> {
                                    Toast.makeText(DialogDetail.this, "Deletion error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                });
                    })
